                        ...
                        <div class="card-header">
                            ...
                            if($button && get_sub_field('button_wrap')):
                                ...
                                <a href="<?php echo $button['url']; ?>">
                                    <img loading="lazy" class="image-fluid features-image lozad" data-src="<?php echo the_sub_field('image') ?>" src="<?php echo the_sub_field('image') ?>" alt="<?php echo $image_alt['alt']; ?>test" />
                                </a>

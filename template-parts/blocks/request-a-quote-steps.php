        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                <div
                    ...
                    <div class="step-number-counter">Step <span id="current-step">1</span> of <span id="total-steps"><?php echo $count + 1; ?></span>
                    </div>
                </div>
            ...
            if (have_rows('steps')):
                ...
                <div class="col-12 text-center">
                    <div class="row justify-content-center current-item <?php echo "step-$step_number"; ?>"
                        ...
                        <div class="col-12 aaaa text-center">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const totalSteps = parseInt(document.getElementById('steps-count').value, 10); // Adjust this if needed
    let currentStep = 1;
    ...
    document.querySelectorAll('.custom-card').forEach(card => {
        card.addEventListener('click', function (event) {
            ...
            document.querySelectorAll('.custom-card').forEach(c => {
                c.classList.remove('selected'); // Remove any existing selection
            });
            this.classList.add('selected'); // Add class to the clicked card
        });
    });

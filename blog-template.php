        ...
        <div class="container-fluid">
            <div class="row align-items-center custom-height justify-content-center">
                <div class="col-12 col-md-6 vertical-middle text-center">
                    <div class="">
                        <h1 class="weight-normal header-heading text-white">Keeping you <br><span class="text-yellow">up-to-date</span></h1>
                        <h3 class="weight-normal text-white">News & Blogs</h3>

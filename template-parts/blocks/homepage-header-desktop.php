        ...
        <div class="row align-items-center custom-height">
            <?php if (get_field('content_alignment') === "left"): ?>
                <div class="col-12 col-lg-5 col-xl-5 padding-v-10 text-center padding-md-right-100 order-0"><img loading="lazy"
                            class="rounded header-image <?php echo $glowing; ?>"
                    ...
                    if (have_rows('header_content_button')):
                        while (have_rows('header_content_button')) : the_row();
                            ...
                            <a target="<?php echo $button['target']; ?>" href="<?php echo $button['url']; ?>">
                                <button class="btn btn-header btn-light margin-right-5 margin-top-20 text-center align-items-center"> <?php echo $button['title']; ?>
                                    <br><span
                                            class="btn header-btn-sub" style='font-size: <?php the_sub_field('button_subtitle_ft'); ?>px!important;'><?php the_sub_field('button_subtitle'); ?>
                                </button>
                            </a>
            ...
            <div class="col-12 social-section order-2">
                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-4 text-center arrow-down-header">
                        <button class="btn bg-transparent border-0 d-none d-lg-inline-flex"> <img decoding="async" src="<?php echo get_template_directory_uri(); ?>/assets/images/arrow-lime.svg"></button>
                    </div>

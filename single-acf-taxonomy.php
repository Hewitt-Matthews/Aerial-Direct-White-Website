				...
				<div class="nav-previous">
					...
					<div class="nav-next">
						<a href="/blog">
							...
							<spam class="post-image" style="background:linear-gradient(to bottom, rgba(255,255,255, 0) 0%, rgba(0,0,0, 1) 100%), url('<?php echo get_field('last_blog_image', 'options') ?>')" >
								<!-- <spam class='nav-subtitle'>Back to Homepage:</spam> -->
								<span class="nav-title">Back to Blogs</span>
							</spam>
						</a>
					</div>
				</div>
